...
Interactive Slicers: Allows users to filter the entire dashboard by Date, City, and Item Type with a single click.

Multi-Dimensional Analysis:

Quantity Analysis: Pie charts showing the distribution of items sold (Keyboard, RAM, SSD, etc.).

Regional Performance: Bar charts comparing sales across Sitapur, Lucknow, and Lakhimpur.

Sales Trends: Line graphs tracking revenue fluctuations from January to April.
...
Excel Slicers: For building the interactive UI/UX.
...
Data: The "Source of Truth" containing raw transactions (S.N, Seller, City, Date, Item, Qty, Rate, Total).

PivotTable: The processing layer where data is aggregated by Month, City, and Seller.

Dashboard: The main executive view providing high-level KPIs like Total Sale Amount (INR 40,87,950).
...
Navigate to the Dashboard or Seller tabs.

Use the Slicers (the blue buttons on the right) to filter data by specific cities or items.
...
Top Region: Sitapur emerges as a high-performing region with over ₹15 Lakhs in sales.
